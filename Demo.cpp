...
int main() {
  ...
  // also insert is placing the value 2 at the second position then moving the
  // previous value bak to the third position
  ...
  /* ouput:
      ...
      3
  */
  std::cout << "Also the size of that list was " << linkedList.size
            << " elements long!" << std::endl;
  std::cout << "However I replaced all the items in the list with the value 5!"
            << std::endl;
  ...
  */
  linkedList.clear();
  std::cout << "Now the list is empty, the size of the list is "
            << linkedList.size << std::endl;
  std::cout << "Also here are the elements of another list" << std::endl;
  showOffCurlyBraces.foreach (element,
